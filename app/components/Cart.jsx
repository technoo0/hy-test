...
function ItemRemoveButton({ lineIds }) {
    ...
    return (
        <fetcher.Form action="/cart" method="post">
            ...
            <button
                className="bg-white border-black text-black hover:text-white hover:bg-black rounded-md font-small text-center my-2 px-2 max-w-xl leading-none border  h-10 flex items-center justify-center"
                type="submit"
            >
                <IconRemove />
            </button>
...
export function CartActions({ checkoutUrl }) {
    ...
    return (
        <div className="flex flex-col mt-2">
            <a
                href={checkoutUrl}
                className="bg-lime-400 text-black px-6 py-3 w-full  text-center font-medium"
            >
